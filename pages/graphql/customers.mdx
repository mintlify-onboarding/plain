...
- You can [**put customers into groups**](/graphql/customers-setup/customer-groups/) to allow you to better organize your support queue. For example, you could break your customers down into what tier they are in (e.g. Free Tier, Teams, Enterprise)
