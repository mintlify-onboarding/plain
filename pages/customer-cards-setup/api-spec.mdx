...
# Building a customer cards API

This page is intended for a technical audience that will be implementing a customer card API.
Check out the [customer cards](../adding-context/customer-cards.md) page for an overview.
...
5. Your APIs then return customer cards that consist of [Plain UI components](../adding-context/ui-components.md)
