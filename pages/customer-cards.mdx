import CustomerCardBasicRequest from '../snippets/integrations/customer-cards/customer-cards-basic-request.mdx';
import CustomerCardBasicResponse from '../snippets/integrations/customer-cards/customer-cards-basic-response.mdx';
