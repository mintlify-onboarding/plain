...
import FirstApiCallTypescriptSDK from '../snippets/typescript-sdk/first-api-call.mdx';

# GraphQL API

Plain's GraphQL API can be used to manage any aspect of Plain. It's the API we use to build the Plain app which means there are no restrictions on what you can do via the API vs the Plain app.
