...
<ImageContainer>![JWT exchange](/images/chat-setup/jwt-diagram.png)</ImageContainer>
...
<ImageContainer>![App key details](/images/chat-setup/chat-setup-4.png)</ImageContainer>
...
<ImageContainer>![App key details](/images/chat-setup/chat-setup-5.png)</ImageContainer>

### Done!

After that, you should land back on the workspace app page. It means the public key has been added successfully.

<ImageContainer>![App key details](/images/chat-setup/chat-setup-6.png)</ImageContainer>
...
<Tabs items={["React", "Script tag"]}>
    ...
    <Tab>
        ...
        As a reminder: In this tutorial we're assuming that you are exposing the customer JWT via the API endpoint `/api/get-customer-jwt`.
    ...
    <Tab>
        ...
        with the key you obtained on [getting an app key](./app-key))
        ...
        At this point your logged-in users will be able to send chat messages to you, and they will all show up as customers in your workspace in the [Support App](https://app.plain.com).
    </Tab>
