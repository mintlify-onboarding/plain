...
This also assumes you've already created some customer groups in your settings.
...
<Tabs items={[ 'Typescript SDK', 'GraphQL']}>
    ...
    const client = new PlainClient({ apiKey: 'plainApiKey_GbPkA0Y5BXVTNZOhIpFZ_YkYNcWX1QH5paTjHuuyDmE' });
