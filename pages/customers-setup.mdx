...
- You can [**put customers into groups**](/customers-setup/customer-groups/) to allow you to better organize your support queue. For example, you could break your customers down into what tier they are in (e.g. Free Tier, Teams, Enterprise)
- You can [**create customers**](/customers-setup/upsert/) in Plain when they sign-up so that you can reach out to them proactively without waiting for them to get in touch.
- You can [**save your own customer's ID**](/customers-setup/upsert) on the Plain customer for use with [**Customer Cards**](/customer-cards/).
