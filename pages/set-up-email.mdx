...
your company's support email address (e.g. `help@yourcompany.com`) to your Plain workspace's inbound email address. Your workspace's email inbound address ends with `@inbound.postmark.app` and can be found in workspace settings under **Settings → Email**.
...
![Add new rule](/images/guides/setup-email/email_0.png)
 
### Set the recipient
In the dropdown, select "Single recipient" and write your **support email address** under "Email address" 

![Add your support email address](/images/guides/setup-email/email_1.png)
...
![DNS settings](/images/guides/setup-email/email_4.png)
