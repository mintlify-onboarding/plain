...
import CreateAttachmentTypescriptSDK from '../snippets/typescript-sdk/create-attachment-url.mdx';
import CreateAttachmentResponseTypescriptSDK from '../snippets/typescript-sdk/create-attachment-url-response.mdx';
import CreateAttachmentGraphQL from '../snippets/graphql/create-attachment-url.mdx';
import UploadAttachmentBrowser from '../snippets/browser/upload-attachment.mdx';
import UploadAttachmentNode from '../snippets/node/upload-attachment.mdx';

# File Attachments

When using Plain's API to send emails or creating [Custom Timeline Entry](/custom-timeline-entries) you can add file attachments.
