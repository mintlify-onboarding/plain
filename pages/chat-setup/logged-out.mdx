...
This allows customers who are not logged-in to chat to you.
...
<Tabs items={['React', 'Script tag']}>
    ...
    <Tab>
        ...
        If you don't need to support logged-in users, this is all you need to do! Your users will now be able to chat to you, and they will show up in your workspace in the [Plain](https://app.plain.com).
