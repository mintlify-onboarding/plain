...
![Screenshot of the customer cards feature](/images/customer-cards-setup/customer-cards-headline.png)
...
2. Plain fires a request to your back-end with:
   ...
   - The customers email, `externalId`
...
![Customer Cards Playground](/images/customer-cards-setup/customer-cards-playground.png)
