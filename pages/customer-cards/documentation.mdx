...
import CustomerCardsNoDisplayResponse from '../../snippets/integrations/customer-cards/customer-cards-no-display-response.mdx';
import CustomerCardsRequest from '../../snippets/integrations/customer-cards/customer-cards-request.mdx';
import CustomerCardsResponse from '../../snippets/integrations/customer-cards/customer-cards-response.mdx';
...
<CustomerCardsNoDisplayResponse />
