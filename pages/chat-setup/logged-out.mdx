...
<Tabs items={['React', 'Script tag']}>
    ...
    <Tab>
        ...
        If you need an example, this is a very minimal web page with Plain chat integrated. To use this, replace the text `APP_KEY` with the key you got in the [getting an app key](./app-key/) section.
