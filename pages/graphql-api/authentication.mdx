...
- **Name:** This is just visibile to you and could indicate the usage e.g. "Autoresponder"
...
Otherwise throughout the documentation the required permissions per API call will be listed.

Once you've made an API key you can copy it and put it somewhere safe.
