import ErrorHandlingGraphQL from '../../snippets/graphql/error-handling.mdx';
import ErrorHandlingTypescriptSDK from '../../snippets/typescript-sdk/error-handling.mdx';
